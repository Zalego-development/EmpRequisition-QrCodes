...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-muted ml-2 mt-2"><strong>Applicants</strong></h1>
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#enrolled" role="tab"
                            ...
                            <strong> Applicants <sup class="badge bg-white shadow-lg text-muted"></sup></strong>
                        </a>
                    </li>
                </ul>
                                                ...
                                                <td>
                                                    <span class="dropdown">
                                                        ...
                                                        <div style="margin-left:-120px !important;"
                                                            ...
                                                            <a class="dropdown-item" href="{{ route('applicants.show',$applicant->id) }}"
                                                                style="cursor:pointer;" title="View more">
                                                                <i class="fa fa-eye text-warning"></i> View Details</a>
                                                            <div>
                                                                <a class="dropdown-item" href="{{ route('sendmail.applicant',$applicant) }}"
                                                                    style="cursor:pointer;">
                                                                    <i class="fa fa-check text-warning"></i> Approve
                                                                </a>
                                                            </div>
                                                            <div style="text-align: center">
                                                                <form
                                                                    ...
                                                                    data-target="#editCurriculum">
                                                                    <i class="fa fa-ban text-warning"></i> Decline
                                                                </a>
                                                                </form>
                                                            </div>
                                                        </div><br>
