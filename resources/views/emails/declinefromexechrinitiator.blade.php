  ...
  <tbody>
                      ...
                      #manipulate the output
                        $recruitemntapprover=DB::table('requsitionsapprovals')
                          ...
                          $hrapprover=DB::table('requsitionsapprovals')
                                            ...
                                            ->where('employeerequisitionusers.employeetype', 'HR Manager')
                                            ->first();
                   $leadapprover=DB::table('requisitionsdeclines')
          ...
          <tr>
            <td style="padding:30px;background:orange;">
              <p style="margin:0;font-size:12px;line-height:14px;font-family:Arial,sans-serif;"> <a href="{{ url('approvetoHR/' . $data['id'])}}" id="{{$data['id']}}"> Approve</a>&nbsp;&nbsp;|<a href="{{ url('decline/' . $data['id'])}}" id="{{$data['id']}}"> Decline</a>&nbsp;&nbsp; |<a href="{{ url('returnforcorrections/' . $data['id'].'/'.$data['user'])}}" id="{{$data['id']}}"> Return For Corrections</a></p>
