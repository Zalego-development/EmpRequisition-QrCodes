...
<body style="margin:0;padding:0;">
 ...
 <tbody>
     @php
          ...
          <tr>
            <!-- declinefroexecempinitator -->
            <td style="padding:30px;background:orange;">
                      <p style="margin:0;font-size:12px;line-height:14px;font-family:Arial,sans-serif;"> <a href="{{ url('approvetoceo/' . $data['id'].'/'. $data['rec'])}}"> Approve</a>|&nbsp;&nbsp;<a href="{{ url('declinereasonfromexecempinitator/' . $data['id'])}}"> Decline</a>|&nbsp;&nbsp;<a href="{{ url('returnforcorrections/' . $data['id'].'/'.$data['user'])}}" id="{{$data['id']}}"> Return For Corrections</a><br></p>
                         <p style="margin:0;font-size:12px;line-height:14px;font-family:Arial,sans-serif;">  <a href="{{route ('calltoaction2')}}"> click here for an action</a><br><br></p>
