     ...
     @php
          ...
          <tr>
            <td style="padding:30px;background:orange;">
                      <p style="margin:0;font-size:12px;line-height:14px;font-family:Arial,sans-serif;"> <a href="{{ url('approve/' . $data['id'])}}"> Approve</a> &nbsp;&nbsp;| <a href="{{ url('declinefromhrempinitator/' . $data['id'])}}"> Decline</a> &nbsp;&nbsp;|<a href="{{ url('returnforcorrections/' . $data['id'].'/'.$data['user'])}}" id="{{$data['id']}}"> Return For Corrections</a><br></p>
