...
<body style="margin:0;padding:0;">
  ...
  <!-- declinefromceorecruinitiator -->
            <p style="margin:0;font-size:12px;line-height:14px;font-family:Arial,sans-serif;"> <a href="{{ url('approvefromchiefrecruinitiator/'. $data['id'].'/'.$data['rec'])}}"> Approve</a>&nbsp;&nbsp;&nbsp;|<a href="{{ url('declinereasonfromceorecinitiator/' . $data['id'])}}"> Decline</a>&nbsp;&nbsp;| <a href="{{ url('returnforcorrections/' . $data['id'].'/'.$data['user'])}}" id="{{$data['id']}}"> Return For Corrections</a></p>
                         <p style="margin:0;font-size:12px;line-height:14px;font-family:Arial,sans-serif;">  <a href="{{route ('calltoactionceorecruinitiator')}}"> click here for an action</a><br><br></p>
