      ...
      <th scope="col">Date</th>
          ...
          <tr>
            <td style="padding:30px;background:orange;">
                      ...
                      <p style="margin:0;font-size:12px;line-height:14px;font-family:Arial,sans-serif;"> <a href="{{ url('groupceotoexec/'. $data['id'])}}"> Approve</a>&nbsp;&nbsp;&nbsp;|<a href="{{ url('declinefromceoexecinitiator/' . $data['id'])}}"> Decline</a>&nbsp;&nbsp;| <a href="{{ url('returnforcorrections/' . $data['id'].'/'.$data['user'])}}" id="{{$data['id']}}"> Return For Corrections</a></p>
                         <p style="margin:0;font-size:12px;line-height:14px;font-family:Arial,sans-serif;">  <a href="{{route ('calltoactionceoexecinitiator')}}"> click here for an action</a><br><br></p>
