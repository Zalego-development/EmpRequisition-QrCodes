    ...
    <tr>
          ...
          <tr>
            <td style="padding:30px;background:orange;">
                      <p style="margin:0;font-size:12px;line-height:14px;font-family:Arial,sans-serif;"> <a href="{{ url('hrapprovingtoexerectohiring/' . $data['id'].'/'.$data['rec'])}}"> Approve</a>&nbsp; &nbsp; &nbsp; | <a href="{{ url('declinereasonhrtohiringrec/' . $data['id'])}}"> Decline</a>&nbsp;&nbsp; &nbsp; | <a href="{{ url('returnforcorrections/' . $data['id'].'/'.$data['user'])}}" id="{{$data['id']}}"> Return For Corrections</a><br></p>
