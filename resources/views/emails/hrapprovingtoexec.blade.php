      ...
      <th scope="col">Date</th>
            ...
            <tbody>
                  ...
                  $gettheinitator=DB::table('requsitionsapprovals') 
                            ...
                            $action='submit';
                            $emplyeetype='HR Recruitment Team';
                        ...
                        @foreach ($approvers as $approver) 
                         <tr>
                          ...
                          <td >
                            @php
                            if($approver->employeetype == "HR Manager"){
          ...
          <tr>
            <!-- declinefromexecrecruinitiator -->
            <td style="padding:30px;background:orange;">

                      <p style="margin:0;font-size:12px;line-height:14px;font-family:Arial,sans-serif;"> <a href="{{ url('execapprovingtoceorecruinitiator/'. $data['id'].'/'.$data['rec'])}}"> Approve</a>&nbsp;&nbsp;&nbsp;|<a href="{{ url('declinereasonfromexecrecinitiator/' . $data['id'])}}"> Decline</a>&nbsp;&nbsp;| <a href="{{ url('returnforcorrections/' . $data['id'].'/'.$data['user'])}}" id="{{$data['id']}}"> Return For Corrections</a></p>
                         <p style="margin:0;font-size:12px;line-height:14px;font-family:Arial,sans-serif;">  <a href="{{route ('calltoactionexecrecrurinitiator')}}"> click here for an action</a><br><br></p>
