      ...
      <th scope="col">Date</th>
          ...
          <tr>
            <td style="padding:30px;background:orange;">
                      ...
                      <p style="margin:0;font-size:12px;line-height:14px;font-family:Arial,sans-serif;"> <a href="{{ url('execapprovingtoceorecruinitiator/'. $data['id'])}}"> Approve</a>&nbsp;&nbsp;&nbsp;|<a href="{{ url('declinefromexecrecruinitiator/' . $data['id'])}}"> Decline</a>&nbsp;&nbsp;| <a href="{{ url('returnforcorrections/' . $data['id'].'/'.$data['user'])}}" id="{{$data['id']}}"> Return For Corrections</a></p>
