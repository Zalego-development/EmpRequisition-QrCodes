        ...
        <table role="presentation" style="width:602px;border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;text-align:left;">
          <tr>
            <td align="center" style="padding:20px 0 15px 0;background:orange;">
              <h2 style="color: #ffffff">Recruitment Requisitions</h2>
            </td>
          </tr>
          <tr>
  ...
  <tbody>
    <tr>
                      ...
                      $gettheinitator=DB::table('requsitionsapprovals') 
                            ...
                            $action='submit';
                            $emplyeetype='HR Recruitement Team';
          ...
          <tr>
            <td style="padding:30px;background:orange;">
                      <p style="margin:0;font-size:12px;line-height:14px;font-family:Arial,sans-serif;"> <a href="{{ url('hiringapprovingtohr/' . $data['id'].'/'.$data['rec'])}}"> Approve</a>&nbsp; &nbsp; &nbsp; | <a href="{{ url('declinereasonfromhiringtorec/' . $data['id'])}}"> Decline</a>&nbsp;&nbsp; &nbsp; | <a href="{{ url('returnforcorrections/' . $data['id'].'/'.$data['user'])}}" id="{{$data['id']}}"> Return For Corrections</a><br></p>
