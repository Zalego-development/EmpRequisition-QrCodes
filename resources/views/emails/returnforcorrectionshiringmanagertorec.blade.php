                  ...
                  <td style="padding:0;">
                    <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                      ...
                      <p style="margin:0 0 12px 0;font-size:12px;line-height:14px;font-family:Arial,sans-serif;">Target People::
                          ...
                          <p style="margin:0 0 12px 0;font-size:12px;line-height:14px;font-family:Arial,sans-serif;">Projected Starting date::{{ $data['startdate'] }}</p>
    ...
    <tr>
                        ...
                        $pushdata=(object) ['id'=> $id,'name'=>$manname, 'employeetype'=>$employeetype ,'action'=>$action]; 
                         array_unshift($approvers, $pushdata);
                          ...
                          $getdateofmanagerapprovals=DB::table('job_approvals')
                                                     ->where('job_approvals.jobid', $data['id'])
                                                     ->where('commentby',$managername->id )
                                                     ->first();
                      ...
                      $gettheinitator=DB::table('requsitionsapprovals') 
                            ...
                            $date=$gettheinitator->created_at;
                        ...
                        @foreach ($approvers as $approver) 
                         ...
                         @if($approver->id == $getdateofmanagerapprovals->userId)
                           <p>  {{$getdateofmanagerapprovals->created_at}}</p>
