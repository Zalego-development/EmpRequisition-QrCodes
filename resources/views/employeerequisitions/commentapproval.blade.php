...
@endif
     <form method="POST" action="{{ url('commentsapprovalstore') }}">
     @csrf
    ...
    <div class="form-group">
            <input type="text" name="userId" value="{{$useremail->id}}" hidden="">
    </div>
    <div class="form-group">
      <label for="disabledTextInput">Make A Comment</label>
