...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-muted ml-2 mt-2"><strong>Declined Requisition</strong></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                        ...
                                                        <div style="margin-left:-120px !important;"
                                                           ...
                                                           <a href="" class="dropdown-item"  data-toggle="modal" data-target="#exampleModaledit{{$emprequest->id}}"><i class="fa fa-eye text-warning"></i>Approvers|Declined
                                                                  </a>
