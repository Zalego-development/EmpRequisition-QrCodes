                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#enrolled" role="tab"
                            ...
                            <strong> Requisitions Updates <sup class="badge bg-white shadow-lg text-muted"></sup></strong>
                        </a>
                    </li>
                </ul>
                                    ...
                                    <table id="example1" class="table table-hover ">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                @php
                                                $getcommentor=DB::table('job_approvals')
                                                             ->join('users', 'users.id', '=', 'job_approvals.commentby')
                                                             ->where('jobid',$jobapproval->jobid )
                                                             ->first();

                                                $users = App\Models\User::find($jobapproval->userId)->first();
                                                @endphp
                                                <td>{{ $getcommentor->name}}</td>
