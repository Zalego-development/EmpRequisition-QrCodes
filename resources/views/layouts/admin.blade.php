...
<div class="wrapper">
 ...
 @yield('content')
  <footer class="main-footer">
    <strong class="float-right"> <center>Copyright &copy;
     ...
     <!--    <div class="footerr ">
  <p class="text-muted py-1 px-3 mt-3"><img src="https://zalegoinstitute.ac.ke/public/asset/img/logo.png" 
    width="35px" height="35px" style="margin-top:-7px;" class="shadow-lg rounded-circle" alt="Zalego_logo">&nbsp Powered by 
    <a href="https://zalegoinstitute.ac.ke" target="_blank">Zalego Academy</a></p>
</div> -->
        <a href="http://zalegoinstitute.ac.ke/public/" style="color:#007bff !important"> Zalego Academy.</a></center>
      </strong>
