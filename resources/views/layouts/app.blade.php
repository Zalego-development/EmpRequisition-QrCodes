    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="login100-more">
                <h1 class="ml12 p-l-16 p-t-30"><strong>Zalego HR System</strong></h1><hr>
                <br><br>
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            <div class="carousel-caption d-md-block">
              ...
              <img data-animation="animated bounceInLeft" src="{{asset('assets/images/shots/10.jpg')}}" class="d-block w-100" alt="...">
              <h3 data-animation="animated bounceInRight">
               <img src="{{asset('assets/images/shots/16.gif')}}" width="15px" height="15px" class="shadow-lg" style="margin-top: -10px;" alt="..."> Employee Management
              </h3>
            </div>
          </div>
          ...
          <div class="carousel-item skyblue">
            <div class="carousel-caption d-md-block">
              ...
              <h3 data-animation="animated bounceInRight">
               <img src="{{asset('assets/images/shots/16.gif')}}" width="15px" height="15px" class="shadow-lg" style="margin-top: -10px;" alt="..."> Tasks Management
              </h3>
          ...
          <div class="carousel-item skyblue">
            <div class="carousel-caption d-md-block">
              ...
              <h3 data-animation="animated bounceInLeft">
               <img src="{{asset('assets/images/shots/16.gif')}}" width="15px" height="15px" class="shadow-lg" style="margin-top: -10px;" alt="..."> Project Management
              </h3>
          ...
          <div class="carousel-item skyblue">
            <div class="carousel-caption d-md-block">
                <img data-animation="animated flipInX" src="{{asset('assets/images/shots/16.jpg')}}" class="d-block w-100" alt="...">
              <h3 data-animation="animated bounceInUp">
               <img src="{{asset('assets/images/shots/16.gif')}}" width="15px" height="15px" class="shadow-lg" style="margin-top: -10px;" alt="..."> Payroll Management
              </h3>
          ...
          <div class="carousel-item skyblue">
            <div class="carousel-caption d-md-block">
                <img data-animation="animated bounceInRight" src="{{asset('assets/images/shots/11.jpg')}}" class="d-block w-100" alt="...">
              <h3 data-animation="animated bounceInUp">
